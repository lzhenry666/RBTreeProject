...
public class RBTree
{
	...
	public static class RBNode
	{
		...
		private static final int DUMMY_LEFT_KEY = -10; // The key that is used
														// to idetify a left
														// dummy node.
		private static final int DUMMY_RIGHT_KEY = -20; // The key that is used
														// to identify a right
														// dummy node.
	...
	private boolean assertSizes(RBNode node)
	{
		...
		return node.getSize() == 1 + (node.getLeft() != null ? node.getLeft().getSize() : 0)
